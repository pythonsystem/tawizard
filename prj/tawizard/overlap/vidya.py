...
from tawizard.utils import get_drift, get_offset, verify_series
...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n:int , d: int):
        ...
        For some reason: from tawizard.momentum import cmo causes
        tawizard.momentum.coppock to not be able to import it's
        wma like from tawizard.overlap import wma?
